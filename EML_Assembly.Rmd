...
# isolate old node (Currently hardcoded)
diet_children <- xml_children(diet_eml)
oldnode <- xml_children(diet_children[[2]])[[16]] # loc 16 is the project node
# designate new node
newnode <- proj_eml
...
xml_children(diet_children[[2]])[[16]]
